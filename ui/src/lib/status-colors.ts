...
export const issueStatusIcon: Record<string, string> = {
  ...
  ready: "text-teal-600 border-teal-600 dark:text-teal-400 dark:border-teal-400",
  ...
  qa: "text-orange-600 border-orange-600 dark:text-orange-400 dark:border-orange-400",
  deploy: "text-sky-600 border-sky-600 dark:text-sky-400 dark:border-sky-400",
...
export const statusBadge: Record<string, string> = {
  ...
  ready: "bg-teal-100 text-teal-700 dark:bg-teal-900/50 dark:text-teal-300",
  ...
  qa: "bg-orange-100 text-orange-700 dark:bg-orange-900/50 dark:text-orange-300",
  deploy: "bg-sky-100 text-sky-700 dark:bg-sky-900/50 dark:text-sky-300",
