...
export function companyService(db: Db) {
  ...
  const companySelection = {
    ...
    kanbanConfig: companies.kanbanConfig,
    kanbanGitUrl: companies.kanbanGitUrl,
    kanbanLastSyncedAt: companies.kanbanLastSyncedAt,
    kanbanLastSyncError: companies.kanbanLastSyncError,
    kanbanGitSha: companies.kanbanGitSha,
