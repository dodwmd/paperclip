...
import { resolveDefaultAgentWorkspaceDir, resolveDefaultAgentHomeDir, resolveManagedProjectWorkspaceDir } from "../home-paths.js";
  ...
  async function executeRun(runId: string) {
    ...
    try {
      ...
      await setRunStatus(run.id, status, {
        ...
        usageJson,
        toolCallsJson: adapterResult.toolCalls ?? null,
